...
//{
//    public class NewPlayer : MonoBehaviourPun, IPunObservable
//    {
//        [HideInInspector]
...
//            if (!photonView.IsMine && GetComponent<NewController>() != null)
//                Destroy(GetComponent<NewController>());
//        }
...
//        public static void RefreshInstance(ref NewPlayer player, NewPlayer Prefab)
//        {
...
//            player = PhotonNetwork.Instantiate(Prefab.gameObject.name, position, rotation).GetComponent<NewPlayer>();
//        }
